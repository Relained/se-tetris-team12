...
public class ScoreState extends GameState {
    ...
    public ScoreState(GameStateManager stateManager, int score, int lines, int level) {
        super(stateManager);
    ...
    public ScoreState(GameStateManager stateManager, boolean showNewlyAddedHighlight) {
        super(stateManager);
    ...
    public ScoreState(GameStateManager stateManager) {
