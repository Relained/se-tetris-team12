...
public class StartView extends BaseView {
     ...
     * @param onItemStartGame Start Game (Item Mode) 버튼 클릭 시 실행될 콜백
     ...
     */
    public VBox createView(Runnable onStartGame, Runnable onItemStartGame, Runnable onViewScoreboard, Runnable onSetting, Runnable onExit) {
        ...
        var itemStartButton = buttonSystem.createNavigableButton("Start Item Mode", onItemStartGame);
        ...
        root.getChildren().addAll(title, subtitle, startButton, itemStartButton, scoreboardButton, settingButton, exitButton, controls);
