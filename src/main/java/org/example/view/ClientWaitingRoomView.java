...
public class ClientWaitingRoomView extends BaseView {

    public ClientWaitingRoomView() {
        super(true);
    }

    public VBox createView(Runnable onGoBack) {
        ...
        Text title = new Text("Client Waiting Room");
