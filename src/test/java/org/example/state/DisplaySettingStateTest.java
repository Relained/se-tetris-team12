...
class DisplaySettingStateTest extends ApplicationTest {
    
    private StateManager stateManager;
    private DisplaySettingState state;
    ...
    void setUp() {
        ...
        state = new DisplaySettingState(stateManager);
    }
    ...
    @Test
    @DisplayName("exit() - 화면 크기 설정 저장")
    void testExitSavesSettings() {
        javafx.application.Platform.runLater(() -> {
            state.enter();
            state.createScene();
